...
def apk(actual, predicted, k=10):
  ...
  # create empty list pks
  pks = []
  
  # find the PK for every one recall increases
  
  #loop through each value in k_preducted_items
  for i, p in enumerate(k_predicted_items):
      if p in actual:
          pks.append(pk(actual, predicted, i+1))
  # return the average
